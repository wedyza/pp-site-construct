...
const PurchasedCard: React.FC<OrderCardProps> = ({ good, order }) => {
    return (
        <div className="order-card">
            <div className='order_good-card_info'>
                ...
                <div className='order-card_info-item'>
                    ...
                    <p className='order-card_info-item__value text-n16'>{good.price} ₽</p>
                </div>
                ...
                <div className='order-card_action text-n14 order-card_rate'>
                    ...
                    <span>Оставить отзыв и оценить товар</span>
                </div>
            </div>
