        ...
        <div className='review-card'>
            <div className="review-card_header">
                <div className="review-prev_author">
                    ...
                    <span className='review-prev_author-name'>
                        Валерия Б.
                    </span>
                </div>
                <div className="review-prev_info">
                    <div className="review-prev_date">
                        14 апреля 2025
                    </div>
            ...
            <div className="review-card_body">
                <p className='review-card_text text-n14'>
                    Первое впечатление - понравился. 
                    Не поняла почему при работе мигает синий индикатор, по идее не должен мигать..заряжен полностью. 
                    Надеюсь в процессе будет потом понятно. 
                    В остальном всё хорошо, инструкция подробная на русском языке, сам робот шустренький. 
                </p>
