...
const RefundForm: React.FC<RefundModalProps> = ({ setIsOpenFirst, setIsOpenSecond }) => {
    ...
    return (
        <form className="refund-form">
            <textarea placeholder="Опишите причину возврата" className="refund-form_textarea text-n14" />
            <div
            ...
            >
                ...
                <p className='text-desc refund-form_dropzone-desc'>
                    ...
                    чтобы выбрать их на компьютере.
                </p>
                <button
                    type="button"
                    className="refund-form_upload-btn text-n14"
                >
                    Выбрать файлы
                </button>
                <input
