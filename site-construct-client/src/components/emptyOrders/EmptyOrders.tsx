...
const EmptyOrders: React.FC = () => {
    return (
        <div className='empty-orders'>
            <div className="empty-orders_img-container">
                <img className="empty-orders_img" src={emptyOrders} alt="" />
            </div>
            <div className='empty-orders_info'>
                <div className="empty-orders_text text-n16">
