        ...
        <div className='page-content__seller'>
            ...
            <div className='seller-good'>
                <div className='text-h3 seller-orders_title'>
                    ...
                    <span className='seller-good_id text-n11'>id 4565854</span>
                </div>
                <form className="seller-good_form">
                    <div className="seller-good_info seller-good_item">
                        ...
                        <div className="seller-good_info-main">
                            <div className="seller-good_info-group">
                                ...
                                <input className='seller-good_input text-n16' type="text" value={'Робот мойщик окон с распылением'} />
                            </div>
                            <div className="seller-good_info-group">
                                <span className='seller-good_info-label text-n14'>
                                    Цена товара
                                </span>
                                <input className='seller-good_input text-n16' type="text" value={'5 520 ₽'} />
                            </div>
                        </div>
                    ...
                    <div className="seller-good_desc seller-good_item">
                        ...
                        <div className="seller-good_desc-list">
                            <div className="seller-good_desc-item">
                                ...
                                <p className='seller-good_desc-main text-n16'>
                                    Робот-мойщик, сменные салфетки из микрофибры - 12 шт.(+2 салфетки на роботе), 
                                    кольцо для салфетки - 2 шт., блок питания с удлинителем - 4м., 
                                    кабель питания -  1,5 м., страховочный шнур - 4,5 м., инструкция, пульт ДУ
                                </p>
                            </div>
                            <div className="seller-good_desc-item">
                    ...
                    <div className="seller-good_form-btns">
                        <button className='btn-black text-btn seller-good_form-btn'>Сохранить товар</button>
