                ...
                <div className="make-order">
                    <div className="order_payment">
                        ...
                        <div className="order_payment-list">
                            <div className="order_payment-card order_payment-card__active">
                                <p className='order_payment-bank text-card'>SberPay</p>
                                <p className='order_payment-number'>...5684</p>
                            </div>
                            <div className="order_payment-card">
                                <p className='order_payment-bank text-card'>SberPay</p>
                                <p className='order_payment-number'>...5684</p>
                            </div>
                        </div>
                    ...
                    <div className="order_del">
                        ...
                        <div className="order_del-info">
                            <div className="order_del-item">
                                ...
                                <p className='order_del-value text-n16'>г. Екатеринбург ул. Малышева 15</p>
                    ...
                    <div className="order_items">
                        ...
                        <p className='text-n14 order_items-count'>3 товара</p>
                        <div className="order_items-list">
                            <div className="order_items-card">
                                ...
                                <div className="order_items-card-text">
                                    <p className="order_item-price text-price1">5 520 ₽</p>
                                    <p className="order_item-name text-n14">Специальное чистящее средство</p>
                                </div>
                            </div>
                            <div className="order_items-card">
                                <div className="order_item-img"></div>
